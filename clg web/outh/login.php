...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".subnav" data-offset="50" screen_capture_injected="true" style="width:100%;min-height:500px">
    ...
    <div class="container" style="height:500px">
		...
		<div class="col-sm-8 col-md-8">
			...
			<form id="loginForm">
				...
				<button type="button" class="btn btn-success btn-lg" onClick="loginData()">Login</button>
			</form>
		</div>
    </div>
